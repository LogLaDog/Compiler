...
public abstract class ParseElement {
    ...
    protected void box(ByteCodeGenerator code, CatscriptType type) {
        if (type.equals(CatscriptType.INT)){
            code.addMethodInstruction(Opcodes.INVOKESTATIC, internalNameFor(Integer.class), "valueOf", "(I)Ljava/lang/Integer;");
        }
        if (type.equals(CatscriptType.BOOLEAN)){
            code.addMethodInstruction(Opcodes.INVOKESTATIC, internalNameFor(Boolean.class), "valueOf", "(Z)Ljava/lang/Boolean;");
        }
    ...
    protected void unbox(ByteCodeGenerator code, CatscriptType type) {
        if (type.equals(CatscriptType.INT)){
            code.addMethodInstruction(Opcodes.INVOKEVIRTUAL, internalNameFor(Integer.class), "intValue", "()I");
        }
        if (type.equals(CatscriptType.BOOLEAN)){
            code.addMethodInstruction(Opcodes.INVOKESTATIC, internalNameFor(Boolean.class), "booleanValue", "()Z");
        }
    }
